    ...
    return (
        <article className={`${styles["reservations-confirmation"]}`}>
            <div className={`${styles["your-booking"]}`}>
                ...
                <ul>
                    {bookingData.map(({ id, data, title, image }) => (
                        ...
                        >
                            <div
                                className={`${styles["your-booking__image-container"]}`}
                            >
                                <Image
                                    src={image}
                                    alt="booking-swimming-cave"
                                    width={
                                        isSmallPhoneViewport ? 180 / 1.35 : 180
                                    }
                                    height={
                                        isSmallPhoneViewport ? 120 / 1.35 : 120
                                    }
                                    sizes="50vw"
                                />
                            </div>
                            <div
                                className={`${styles["your-booking__booking-data"]}`}
                            >
                                <h5
                    ...
                    >
                        ...
                        >
                            Total{" "}
                            <span>
                                {reservationsPickerInformation.totalPrice}$
                            </span>
                        </h5>
                    </li>
                </ul>
            ...
            <div className={`${styles["contact-information"]}`}>
                ...
                <div
                    className={`${styles["contact-information__inputs-container"]}`}
                >
                        ...
                        id === "phone" ? (
                            <PhoneInput
                                ...
                                inputStyle={{
                                    ...
                                    backgroundColor:
                                        defaultTheme.palette.gray.lightMain,
                                    borderRadius: ".4rem",
                                    width: "100%",
                                }}
                                enableTerritories
                            ...
                            <TextField
                                ...
                                variant="filled"
                                value={
                                    reservationsConfirmationInformation[id] ||
                                    ""
                                }
