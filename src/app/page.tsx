      ...
      /> */}
                ...
                >
                    ...
                    >
                        <p className="text-primary">
                            Welcome to Maalum, a unique natural swimming pool in
                            Paje, Zanzibar.
                        </p>
                        <p className="text-primary">
                            A special place to reconnect with nature, explore
                            the underground life, relax and enjoy the peace.
                        </p>
                        <p className="text-primary">
            ...
            <article className={`${styles["book-now"]}`}>
                ...
                >
                    ...
                    >
                        <div
                            className={`${styles["book-now__description"]} col-1-of-2`}
                        >
                            <h3
                                className={`text-primary u-padding-bottom-medium`}
                            >
                            ...
                            <p className="text-primary">
                                The duration of the slot is 90 min. inside the
                                cave area
                            </p>
                        </div>
                        <ul
